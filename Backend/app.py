...
app = Flask(__name__)
CORS(app, resources={r"/*": {"origins": ["https://excelsior-n5yq.vercel.app", "https://excelsior-phi.vercel.app", "https://excelsior-pmfliwgem-jasangill1.vercel.app", 'http://localhost:3000']}})
